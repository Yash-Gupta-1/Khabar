...
const HotScreen = () => {
    ...
    const fetchPostsData = async () => {
        ...
        // In order to Get the Post Of Hot topic we can pass the payload with the key postcategory : 'Hot' or we can filter the data with the Hot Category
    ...
    const renderItem = ({ item }) => (
        <TouchableOpacity style={styles.card}>
            <View style={{ width: '28%', }}>
                {/* <Text style={{ color: 'black', fontSize: 20 }}>Image</Text> */}
                <Image
                    source={{
